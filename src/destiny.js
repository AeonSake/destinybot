...
// ==============================
  ...
  slapp.action('destiny_public_moreinfo_callback', (msg) => {
    ...
    if (if 'attachments' in msg_text && msg_text.attachments.length <= 1) msg_text.attachments.unshift({text: lang.msg.dest.noactivities, fallback: lang.msg.dest.noactivities});
    msg_text.attachments.push(destiny_dismiss_att);
    msg.respond(msg_text);
    return;
  });
