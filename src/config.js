...
let config = module.exports = {
  ...
  destiny_ch: process.env.destiny_ch || this.bot_ch,
  console.log(this.destiny_ch);
  
  // Poll config
  poll_ch: process.env.poll_ch || this.bot_ch,
  
  // Events config
  event_ch: process.env.event_ch || this.bot_ch,
